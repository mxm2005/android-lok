	...
	private void initView() {
		...
		lv_advice.setOnItemClickListener(new OnItemClickListener() {//点击每个item的事件。
			...
			public void onItemClick(AdapterView<?> parent, View view,
		        ...
		        ListView lv_advice = (ListView) textEntryView.findViewById(R.id.lv_advice);
		        SimpleAdapter adapter = new SimpleAdapter(getApplicationContext(), 
		        		getAdviceDate(), 
		        		R.layout.advice_dialog_item, 
		        		new String[]{ "VAF22N", "FGross", "RouteN", "VAF26", "VAF36" }, 
		        		new int[]{ R.id.VAF22N, R.id.FGross, R.id.RouteN, R.id.VAF26, R.id.VAF36 });
		        lv_advice.setAdapter(adapter);
