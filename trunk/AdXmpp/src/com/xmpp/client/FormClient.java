...
public class FormClient extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Chat newchat = cm.createChat("test2@202.104.131.3", null);
			...
			public void chatCreated(Chat chat, boolean able) {
				chat.addMessageListener(new MessageListener() {
					...
					public void processMessage(Chat chat2, Message message) {
						//message from user [test2@202.104.131.3]
						if(message.getFrom().contains("test2@202.104.131.3")){
	...
	private void sendFile(String filepath) {
		...
		final OutgoingFileTransfer fileTransfer = fileTransferManager.createOutgoingFileTransfer("test2@202.104.131.3/Spark 2.6.3");				
