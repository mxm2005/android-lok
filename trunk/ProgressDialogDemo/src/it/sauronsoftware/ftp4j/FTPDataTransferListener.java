...
public interface FTPDataTransferListener {
     ...
     * initialized.
     *
     * @param totalSize the number of bytes should be transmitted
     */
     ...
     * Called to notify the listener that some bytes have been transmitted.
     *
     * @param length The number of the bytes transmitted since the begin of the operation,
     *               at the first call received.
     */
