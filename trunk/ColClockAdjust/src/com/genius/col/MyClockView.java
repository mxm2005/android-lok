...
public class MyClockView extends View implements android.view.View.OnTouchListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawLine(clockCenterX, 0, clockCenterX, canvas.getHeight(),
				paint);
